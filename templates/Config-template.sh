...
PMGRID=NPM_REPLACE                         # basic mesh size for TreePM calculations
...
NGENIC=N_REPLACE                             # generate cosmological ICs, set NGENIC to the FFT grid size used for IC generation
